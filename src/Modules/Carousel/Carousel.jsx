...
const Carousel = () => {
  return (
    <div id="carouselExampleDark" className="carousel slide carousel-dark position-relative" data-bs-ride="carousel">
      <Search />
